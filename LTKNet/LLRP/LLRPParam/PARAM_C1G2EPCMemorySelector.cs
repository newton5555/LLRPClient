...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2EPCMemorySelector : Parameter
  {
    ...
    public override string ToString()
    {
      ...
      int num2 = this.EnablePCBits ? 1 : 0;
      try
      {
    ...
    public static PARAM_C1G2EPCMemorySelector FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_C1G2EPCMemorySelector()
      {
        EnableCRC = (bool) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "EnableCRC"), "u1", ""),
        EnablePCBits = (bool) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "EnablePCBits"), "u1", "")
      };
    }
    ...
    public override void ToBitArray(ref bool[] bit_array, ref int cursor)
    {
      ...
      int num3 = this.EnablePCBits ? 1 : 0;
      try
      {
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.EnableCRC, (int) this.EnableCRC_len, bArr);
      }
      catch
      {
      }
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.EnablePCBits, (int) this.EnablePCBits_len, bArr);
      }
      catch
      {
      }
