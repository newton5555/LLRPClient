...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_PerAntennaReceiveSensitivityRange : Parameter
  {
    ...
    public override string ToString()
    {
      ...
      int sensitivityIndexMin = (int) this.ReceiveSensitivityIndexMin;
      try
      {
      ...
      int sensitivityIndexMax = (int) this.ReceiveSensitivityIndexMax;
      try
      {
    ...
    public static PARAM_PerAntennaReceiveSensitivityRange FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_PerAntennaReceiveSensitivityRange()
      {
        AntennaID = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "AntennaID"), "u16", ""),
        ReceiveSensitivityIndexMin = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "ReceiveSensitivityIndexMin"), "u16", ""),
        ReceiveSensitivityIndexMax = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "ReceiveSensitivityIndexMax"), "u16", "")
      };
    }
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.ReceiveSensitivityIndexMin, (int) this.ReceiveSensitivityIndexMin_len, bArr);
      }
      catch
      {
      }
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.ReceiveSensitivityIndexMax, (int) this.ReceiveSensitivityIndexMax_len, bArr);
      }
      catch
      {
      }
