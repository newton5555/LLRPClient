...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_EPC_96 : Parameter
  {
    ...
    public static PARAM_EPC_96 FromBitArray(ref BitArray bit_array, ref int cursor, int length)
    {
      if (cursor >= length)
    ...
    public static PARAM_EPC_96 FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_EPC_96()
      {
        EPC = (LLRPBitArray) Util.ParseArrayTypeFromString(XmlUtil.GetNodeValue(node, "EPC"), "u96", "Hex")
      };
    }
