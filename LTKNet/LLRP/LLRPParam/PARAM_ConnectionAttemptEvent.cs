...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_ConnectionAttemptEvent : Parameter
  {
    ...
    public static PARAM_ConnectionAttemptEvent FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_ConnectionAttemptEvent()
      {
        Status = (ENUM_ConnectionAttemptStatusType) Enum.Parse(typeof (ENUM_ConnectionAttemptStatusType), XmlUtil.GetNodeValue(node, "Status"))
      };
    }
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.Status, (int) this.Status_len, bArr);
      }
      catch
      {
      }
