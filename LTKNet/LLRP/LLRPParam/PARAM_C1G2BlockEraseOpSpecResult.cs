...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2BlockEraseOpSpecResult : Parameter
  {
    ...
    public static PARAM_C1G2BlockEraseOpSpecResult FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_C1G2BlockEraseOpSpecResult()
      {
        Result = (ENUM_C1G2BlockEraseResultType) Enum.Parse(typeof (ENUM_C1G2BlockEraseResultType), XmlUtil.GetNodeValue(node, "Result")),
