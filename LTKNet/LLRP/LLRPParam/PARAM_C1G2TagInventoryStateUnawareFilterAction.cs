...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2TagInventoryStateUnawareFilterAction : Parameter
  {
    ...
    public static PARAM_C1G2TagInventoryStateUnawareFilterAction FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_C1G2TagInventoryStateUnawareFilterAction()
      {
        Action = (ENUM_C1G2StateUnawareAction) Enum.Parse(typeof (ENUM_C1G2StateUnawareAction), XmlUtil.GetNodeValue(node, "Action"))
      };
    }
