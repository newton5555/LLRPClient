...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_AccessSpecStopTrigger : Parameter
  {
    ...
    public override string ToString()
    {
      ...
      int accessSpecStopTrigger = (int) this.AccessSpecStopTrigger;
      try
      {
      ...
      int operationCountValue = (int) this.OperationCountValue;
      try
      {
    ...
    public static PARAM_AccessSpecStopTrigger FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_AccessSpecStopTrigger()
      {
        AccessSpecStopTrigger = (ENUM_AccessSpecStopTriggerType) Enum.Parse(typeof (ENUM_AccessSpecStopTriggerType), XmlUtil.GetNodeValue(node, "AccessSpecStopTrigger")),
        OperationCountValue = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "OperationCountValue"), "u16", "")
      };
    }
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.AccessSpecStopTrigger, (int) this.AccessSpecStopTrigger_len, bArr);
      }
      catch
      {
      }
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.OperationCountValue, (int) this.OperationCountValue_len, bArr);
      }
      catch
      {
      }
