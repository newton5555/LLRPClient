...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_InventoryParameterSpecID : Parameter
  {
    ...
    public static PARAM_InventoryParameterSpecID FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_InventoryParameterSpecID()
      {
        InventoryParameterSpecID = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "InventoryParameterSpecID"), "u16", "")
      };
    }
