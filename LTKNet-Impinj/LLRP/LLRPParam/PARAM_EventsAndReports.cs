...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_EventsAndReports : Parameter
  {
    ...
    public override string ToString()
    {
      ...
      int num = this.HoldEventsAndReportsUponReconnect ? 1 : 0;
      try
      {
    ...
    public static PARAM_EventsAndReports FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_EventsAndReports()
      {
        HoldEventsAndReportsUponReconnect = (bool) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "HoldEventsAndReportsUponReconnect"), "u1", "")
      };
    }
    ...
    public override void ToBitArray(ref bool[] bit_array, ref int cursor)
    {
      ...
      int num2 = this.HoldEventsAndReportsUponReconnect ? 1 : 0;
      try
      {
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.HoldEventsAndReportsUponReconnect, (int) this.HoldEventsAndReportsUponReconnect_len, bArr);
      }
      catch
      {
      }
