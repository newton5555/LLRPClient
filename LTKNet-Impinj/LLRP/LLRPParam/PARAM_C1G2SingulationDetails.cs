...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2SingulationDetails : Parameter
  {
    ...
    public override string ToString()
    {
      ...
      int numCollisionSlots = (int) this.NumCollisionSlots;
      try
      {
      ...
      int numEmptySlots = (int) this.NumEmptySlots;
      try
      {
    ...
    public static PARAM_C1G2SingulationDetails FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_C1G2SingulationDetails()
      {
        NumCollisionSlots = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "NumCollisionSlots"), "u16", ""),
        NumEmptySlots = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "NumEmptySlots"), "u16", "")
      };
    }
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.NumCollisionSlots, (int) this.NumCollisionSlots_len, bArr);
      }
      catch
      {
      }
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.NumEmptySlots, (int) this.NumEmptySlots_len, bArr);
      }
      catch
      {
      }
