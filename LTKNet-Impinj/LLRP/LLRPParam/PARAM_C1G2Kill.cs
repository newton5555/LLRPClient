...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2Kill : Parameter
  {
    ...
    public static PARAM_C1G2Kill FromBitArray(ref BitArray bit_array, ref int cursor, int length)
    {
      if (cursor >= length)
    ...
    public override string ToString()
    {
      ...
      int killPassword = (int) this.KillPassword;
      try
      {
    ...
    public static PARAM_C1G2Kill FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_C1G2Kill()
      {
        OpSpecID = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "OpSpecID"), "u16", ""),
        KillPassword = (uint) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "KillPassword"), "u32", "")
      };
    }
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.KillPassword, (int) this.KillPassword_len, bArr);
      }
      catch
      {
      }
