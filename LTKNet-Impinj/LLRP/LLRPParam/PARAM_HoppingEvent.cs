...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_HoppingEvent : Parameter
  {
    ...
    public override string ToString()
    {
      ...
      int nextChannelIndex = (int) this.NextChannelIndex;
      try
      {
    ...
    public static PARAM_HoppingEvent FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_HoppingEvent()
      {
        HopTableID = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "HopTableID"), "u16", ""),
        NextChannelIndex = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "NextChannelIndex"), "u16", "")
      };
    }
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.NextChannelIndex, (int) this.NextChannelIndex_len, bArr);
      }
      catch
      {
      }
