...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2RFControl : Parameter
  {
    ...
    public override string ToString()
    {
      ...
      int modeIndex = (int) this.ModeIndex;
      try
      {
    ...
    public static PARAM_C1G2RFControl FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_C1G2RFControl()
      {
        ModeIndex = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "ModeIndex"), "u16", ""),
        Tari = (ushort) Util.ParseValueTypeFromString(XmlUtil.GetNodeValue(node, "Tari"), "u16", "")
      };
    }
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.ModeIndex, (int) this.ModeIndex_len, bArr);
      }
      catch
      {
      }
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.Tari, (int) this.Tari_len, bArr);
      }
      catch
      {
      }
