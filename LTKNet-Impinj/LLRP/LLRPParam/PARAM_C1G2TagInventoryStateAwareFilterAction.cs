...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2TagInventoryStateAwareFilterAction : Parameter
  {
    ...
    public static PARAM_C1G2TagInventoryStateAwareFilterAction FromXmlNode(XmlNode node)
    {
      ...
      return new PARAM_C1G2TagInventoryStateAwareFilterAction()
      {
        Target = (ENUM_C1G2StateAwareTarget) Enum.Parse(typeof (ENUM_C1G2StateAwareTarget), XmlUtil.GetNodeValue(node, "Target")),
        Action = (ENUM_C1G2StateAwareAction) Enum.Parse(typeof (ENUM_C1G2StateAwareAction), XmlUtil.GetNodeValue(node, "Action"))
      };
    }
    ...
    public override void AppendToBitArray(AutoGrowingBitArray bArr)
    {
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.Target, (int) this.Target_len, bArr);
      }
      catch
      {
      }
      ...
      try
      {
        Util.AppendObjToBitArray((object) this.Action, (int) this.Action_len, bArr);
      }
      catch
      {
      }
