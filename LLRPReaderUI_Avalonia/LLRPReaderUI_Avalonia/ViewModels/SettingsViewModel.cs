...
public partial class SettingsViewModel : ViewModelBase
{
    ...
    private void UpdateSelectedChannelFrequency()
    {
        ...
        SelectedChannelFrequency = freqs != null && ChannelIndex > 0 && ChannelIndex <= freqs.Count
            ? $"{freqs[ChannelIndex - 1]:F1} MHz"
            : "-";
    }
    ...
    {
        WeakReferenceMessenger.Default.Send(new StatusUpdateRequestedMessage("SettingsQueryStatus"));
        QueryGpioStatus();
    }
